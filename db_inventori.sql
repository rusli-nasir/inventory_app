...
ALTER TABLE `tabel_inventori_komputer` ADD CONSTRAINT `tabel_inventori_komputer_ibfk_1` FOREIGN KEY (`kd_lab`) REFERENCES `tabel_laboratorium` (`kd_lab`) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE `tabel_inventori_komputer` ADD CONSTRAINT `tabel_inventori_komputer_ibfk_2` FOREIGN KEY (`id_user`) REFERENCES `tabel_admin` (`id_user`) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE `tabel_inventori_non_komputer` ADD CONSTRAINT `tabel_inventori_non_komputer_ibfk_1` FOREIGN KEY (`kd_lab`) REFERENCES `tabel_laboratorium` (`kd_lab`) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE `tabel_inventori_non_komputer` ADD CONSTRAINT `tabel_inventori_non_komputer_ibfk_2` FOREIGN KEY (`id_user`) REFERENCES `tabel_admin` (`id_user`) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE `tabel_laboratorium` ADD CONSTRAINT `tabel_laboratorium_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `tabel_admin` (`id_user`) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE `tabel_maintenance` ADD CONSTRAINT `tabel_maintenance_ibfk_3` FOREIGN KEY (`kd_lab`) REFERENCES `tabel_laboratorium` (`kd_lab`) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE `tabel_maintenance` ADD CONSTRAINT `tabel_maintenance_ibfk_4` FOREIGN KEY (`id_user`) REFERENCES `tabel_admin` (`id_user`) ON DELETE RESTRICT ON UPDATE RESTRICT;
