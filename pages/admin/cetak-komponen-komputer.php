...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Ln(5);
        $this->Cell(188,8,'LAPORAN KOMPONEN KOMPUTER LABORATORIUM',0,1,'C');
        $this->Cell(188,8,'SMP NEGERI 5 MENGWI',0,1,'C');
        $this->Ln(5);
       ...
       $this->SetFont('Times','B',9.5);
        ...
        $this->cell(35,8,'Nama Komponen',1,0,'C');
...
// ambil dari database
$kd_lab = $_GET['kd_lab'];
$query = "SELECT * from tabel_inventori_komponen where kd_lab='$kd_lab'";
...
foreach ($data_mt as $data) {
    ...
    $pdf->cell(35, 7, strtoupper($data['nama_komponen']), 1, 0, 'C');
...
$pdf->Output('Cetak Laporan Komponen Komputer','I');
?>