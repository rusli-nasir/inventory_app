...
$id = $_SESSION['id_user'];
$kd_lab = $_GET['kd_lab']?$_GET['kd_lab'] . '/KMPN':'KMPN';
...
$cetakKode = auto_number($kd_lab,'tabel_inventori_komponen','kd_komponen',3) ;
$kd_lab = $_GET['kd_lab'];
?>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong>Tambah Data Komponen Baru</strong>
                                </div>
                                <div class="card-body card-block">
                                    <form action="insert_komponen_komputer.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="text-input" class=" form-control-label">Kode Komponen</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="text" name="kd_komponen" class="form-control" value="<?php echo $cetakKode; ?>" readonly="readonly">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <select name="kondisi" class="form-control-sm form-control" required>
