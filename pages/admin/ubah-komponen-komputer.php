                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Ubah Data Komponen Baru</strong>
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="edit_komponen_komputer.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            <?php
                                            include('../../config/koneksi.php');
                                            $kd_komponen = $_GET['kd_komponen'];
                                            $query = "SELECT * FROM tabel_inventori_komponen WHERE kd_komponen = '$kd_komponen'";
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Kode Komponen</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="kd_komponen" class="form-control"  value="<?php echo $data_kom[0]['kd_komponen'] ?>" readonly="readonly">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="email-input" class=" form-control-label">Nama Komponen</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="nama_komponen" class="form-control"  value="<?php echo $data_kom[0]['nama_komponen'] ?>">
