  ...
  <script>
    ...
    <?php
      $query = "SELECT nama_inventori,
       ...
       $rusak = mysqli_query($db,"select*from tabel_inventori_non_komputer where kondisi='rusak'  group by nama_inventori ");
       $baik = mysqli_query($db,"select*from tabel_inventori_non_komputer where kondisi='baik'  group by nama_inventori ");                        
    ?>
