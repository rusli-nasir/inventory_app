...
$kd_maintenance = $_POST['kode_maintenance'];
...
$query = "INSERT INTO tabel_maintenance VALUES ('$kd_maintenance','','$kd_komputer','$kd_lab','$id_user','$tanggal_lapor','$jadwal_maintenance','$maintenance_selanjutnya','$keterangan','$status');";
