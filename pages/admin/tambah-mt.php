                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Tambah Data Maintenance Komputer</strong>
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="insert_maintenance.php" method="post" class="form-horizontal">
                                            <div class="row form-group">
                                                <div class="col col-md-2">
                                                    <label for="text-input" class=" form-control-label">Kode Maintenance</label>
                                                </div>
                                                <div class="col-12 col-md-4">
                                                    <input type="text" name="kode_maintenance" class="form-control" value="<?php echo $cetakKode; ?>" readonly="readonly">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-4">
                                                    ...
                                                    ?>
                                                   <select name="kd_lab" class="form-control-sm form-control" id="kd_lab">
