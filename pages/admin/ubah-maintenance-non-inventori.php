                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Ubah Data Non Komputer</strong>
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="edit_mt_non_komputer.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            <?php
                                             ...
                                             <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-4">
                                                   <?php
                                                    ...
                                                    ?>
                                                   <select name="kd_inventori" class="form-control-sm form-control">
                                            ...
                                            <div class="button-submit">
                                                ...
                                                <button type="reset" class="btn btn-danger btn-sm" onclick="window.location.href='data-mt-nonkomputer.php'">Batal</button>
                                            </div>
                                            </div>
                                        </form>
                                    </div>  
