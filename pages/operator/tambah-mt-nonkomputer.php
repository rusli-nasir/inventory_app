                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Tambah Data Maintenance Non Komputer</strong>
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="insert_maintenance_non.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-4">
                                                    ...
                                                    ?>
                                                   <select name="kode_lab" class="form-control-sm form-control" id="kd_lab">
                                            ...
                                            <div class="row form-group">
                                             ...
                                             <div class="row form-group">
                                               <div class="col col-md-2">
                                                ...
                                                <div class="col-12 col-md-4">
                                            <select name="kd_inventori" class="form-control-sm form-control" id="kd_inventori">
                                                ...
                                                <div class="col-12 col-md-4">
                                                   <input type="text" name="status" class="form-control" value="Belum Dikerjakan" readonly>
                                                </div>
