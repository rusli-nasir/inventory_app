...
$kd_inventori = null;//$_POST['kd_inventori'];
...
$query = "INSERT INTO tabel_maintenance VALUES ('$kd_maintenance','$kd_inventori','$kd_komputer','$kd_lab',
'$id_user','$tanggal_lapor','$jadwal_maintenance','$maintenance_selanjutnya','$keterangan','$status',
