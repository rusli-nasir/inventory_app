                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <a href="cetak-laporan-nonkomputer.php?kd_lab=<?php echo $kd_lab ?>" class="btn btn-primary" type="button" style="margin-top: 20px;"><i class="fa fa-print"></i>&nbsp Cetak Pdf</a> 
                            </div>
                        </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header">
                                        ...
                                        ?>
                                         <?php foreach ($data_lab as $data) :  ?>
                                        <strong>Inventaris yang rusak di <?php echo $data['nama_lab']; ?></strong>
                                    <?php  endforeach ?>
                                    </div>
                                   ...
                                   <table id="example" class="table table-striped table-bordered">
                                        <thead>
                                         ...
                                         <?php
                                            $no=0;
                                            $query = "SELECT * FROM tabel_inventori_non_komputer where kd_lab ='$kd_lab' and kondisi = 'rusak' ";
                                            $hasil = mysqli_query($db, $query);
                                            $data_inv = array();
                                            while ($row = mysqli_fetch_assoc($hasil)) {
                                            $data_inv[] = $row;
