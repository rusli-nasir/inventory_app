...
$query = "INSERT INTO tabel_inventori_komputer VALUES ('$kd_komputer','$kd_lab','$id_user','$nama_komputer','$tahun','$kondisi_komputer','$os_komputer','$monitor','$keyboard','$mouse','$memory','$hdd','$processor','$ups','$komponen_lain','$keterangan','$status');";
