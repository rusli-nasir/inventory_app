                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header">
                                        <strong>Daftar Maintenance Non Komputer</strong>
                                    </div>
                                     ...
                                     <table id="example" class="table table-striped table-bordered">
                                        <thead>
                                         ...
                                         <?php
                                            ...
                                            $query = "
                                            SELECT * FROM tabel_maintenance where status = 'Dikerjakan' AND kd_inventori is not null ";
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="card">
                                       ...
                                       <div class="card-header">
                                        <strong>Daftar Maintenance Non Komputer yang Belum dikerjakan</strong>
                                    </div>
                                     ...
                                     <table id="example" class="table table-striped table-bordered">
                                        <thead>
                                         ...
                                         <?php
                                            ...
                                            include "../../config/koneksi.php";
                                            $query = "
                                            SELECT * FROM tabel_maintenance where status='Belum Dikerjakan' AND kd_inventori is not null ";
                                            $hasil = mysqli_query($db, $query);
                                            $data_mt = array();
                                            while ($row = mysqli_fetch_assoc($hasil)) {
                                            $data_mt[] = $row;
